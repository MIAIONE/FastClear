Public Class MainWindow
    ...
    Private Sub 退出后台服务程序ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles 退出后台服务程序ToolStripMenuItem.Click
        If ServicesRun.ServiceHelper.IsServiceExisted Then
            If ServicesRun.ServiceHelper.GetServiceStatus <> ServiceControllerStatus.Stopped Then
                If ServicesRun.ServiceHelper.GetServiceStatus <> ServiceControllerStatus.StopPending Then
                    ServicesRun.ServiceHelper.GetService.Stop()
                End If
            End If
        End If
    End Sub
